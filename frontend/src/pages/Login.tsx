...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center">
        ...
        <h1 className="text-white font-black tracking-[0.5em] animate-pulse uppercase">Initializing Session...</h1>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-6 font-sans overflow-hidden relative">
      ...
      <div className="w-full max-w-[650px] bg-white rounded-[3rem] shadow-[0_50px_100px_-20px_rgba(79,70,229,0.15)] p-14 border border-slate-100 relative z-10">
        ...
        <div className="flex flex-col items-center mb-14 text-center">
          <div className="relative w-24 h-24 perspective-1000 mb-8">
            ...
            <div className="w-full h-full relative animate-[flip_8s_linear_infinite] preserve-3d">
              <div className="absolute inset-0 w-full h-full bg-slate-900 rounded-[2rem] flex items-center justify-center border-2 border-indigo-500 shadow-2xl backface-hidden">
                <span className="text-white font-black text-5xl italic tracking-tighter">C</span>
              </div>
          ...
          <h1 className="flex items-baseline font-black text-slate-800 tracking-tighter">
            <span className="text-7xl text-indigo-600 mr-1 animate-pulse">C</span>
        ...
        <form onSubmit={handleLogin} className="space-y-6 max-w-[400px] mx-auto">
          {error && (
          ...
          <div className="space-y-2">
            <label className="text-[11px] font-black uppercase tracking-widest text-slate-400 ml-2">Authorized ID</label>
          ...
          <div className="space-y-2">
            <label className="text-[11px] font-black uppercase tracking-widest text-slate-400 ml-2">Security Key</label>
            <div className="relative group">
          ...
          <button type="submit" className="w-full bg-slate-950 text-white py-5 rounded-2xl font-black uppercase tracking-[0.2em] text-xs flex items-center justify-center gap-3 shadow-2xl hover:bg-indigo-600 transition-all duration-500 group mt-4">
            Initialize Session
